    ...
    <div className="flex h-screen w-full">
      ...
      <div className="hidden lg:flex flex-1 bg-[#6c63ff] relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center p-8 text-white max-w-lg">
          <h1 className={`text-5xl font-bold mb-6 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            <span className="inline-block animation-delay-300">Event</span>
            <span className="inline-block animation-delay-500">Wise</span>
          </h1>
          
          <p className={`text-xl mb-8 leading-relaxed ${isVisible ? 'animate-fade-up animation-delay-700' : 'opacity-0'}`}>
            Plan events, manage budgets, and find vendors - all in one place.
          </p>

          <div className={`flex justify-center ${isVisible ? 'animate-fade-up animation-delay-1000' : 'opacity-0'}`}>
            <Image
              src={eventwise}
              width={350}
              height={350}
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-gray-900">
        <div className={`w-full max-w-md ${isVisible ? 'animate-fade-in animation-delay-300' : 'opacity-0'}`}>
          <Card className="w-full text-white bg-transparent border border-gray-700">
            <CardHeader>
              <CardTitle className="text-2xl">Create an Account</CardTitle>
              <CardDescription>
                Join EventWise to start planning your events
              </CardDescription>
            </CardHeader>
            <CardContent>
              {authError && (
                ...
                <div className="space-y-1 relative">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-transparent border-gray-700 focus:border-[#6c63ff] transition-colors pr-10 h-12"
                      {...register("password")}
                    />
                    <div
            ...
            <CardFooter className="flex justify-center">
              <p className="text-sm">
                ...
                <Link href="/login" className="text-[#6c63ff] hover:text-[#5a52d4] font-semibold">
                  Login
                </Link>
              </p>
            </CardFooter>
